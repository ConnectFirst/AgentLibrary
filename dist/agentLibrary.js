/*! cf-agent-library - v2.1.10 - 2019-05-09 */
/**
 ...
 *           "altDefaultLoginDest": "6001@169.54.178.37",
 *           "phoneLoginPin": "",
...
AuthenticateRequest.prototype.processResponse = function(response) {
    ...
    model.applicationSettings.socketDest = "wss://" + response.iqUrl + ":" + response.port;
    ...
    processResponse: function(instance, response)
    {
        ...
        switch (type.toUpperCase()) {
            ...
            case MESSAGE_TYPES.LEAD_UPDATE:
                ...
                break;
            // todo - dlb - handle stats and callbacks after authentication
...
function initAgentLibrarySocket (context) {
    ...
    AgentLibrary.prototype.socketOpened = function(){
        ...
        UIModel.getInstance().agentSettings.agentId = agentId;
...
function initAgentLibraryAgent (context) {
     ...
     */
    AgentLibrary.prototype.authenticateAgent = function(username, password, platformId, jwt, tokenType, callback){
        UIModel.getInstance().authenticateRequest = new AuthenticateRequest(username, password, platformId, jwt, tokenType);
